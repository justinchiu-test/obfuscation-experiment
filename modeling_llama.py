...
# Llama-specific components that extend shared library classes

class LlamaRMSNorm(RMSNorm):
    """LlamaRMSNorm is equivalent to T5LayerNorm - just an alias to shared RMSNorm"""
    pass


class LlamaRotaryEmbedding(BaseRotaryEmbedding):
    """LlamaRotaryEmbedding - just an alias to shared BaseRotaryEmbedding"""
    pass
